...
function selectVariant(variant) {
  ...
  // Озвучуємо саме обраний варіант: сервер кладе фразу в `variant.speech`
  // (адитивно, разом з картками), тож після тапу чути номери маршрутів
  // вибраного варіанта, а не залишок кореневого плану. `stopVoice()` вище
  // зупиняє попередню фразу — це навмисно, щоб дві не грали одночасно.
  speakPlanSummary(planForMap);
